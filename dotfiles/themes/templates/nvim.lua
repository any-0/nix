...
local highlights = {
    ...
    Cursor = { fg = c.bg, bg = c.secondary, bold = true },
    ...
    StatusLineNC = { fg = c.fg, bg = "#@surfaceStrong@" },
    VertSplit = { fg = "#@muted@", bg = c.bg },
    Visual = { bg = c.selection, fg = "#@foreground@" },
    Pmenu = { fg = c.fg, bg = "#@surface@" },
    PmenuSel = { fg = "#@onColor@", bg = c.accent },
    Search = { fg = "#@onColor@", bg = c.secondary },
    IncSearch = { fg = "#@onColor@", bg = c.secondary },
    ...
    ["@field"] = { fg = c.fg },
    ["@parameter"] = { fg = "#@subtle@", italic = true },
